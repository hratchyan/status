...
const SERVICE_DIR_MAP: Record<string, string> = {
  ...
  'Zapier (São Paulo)': 'zapier-s-o-paulo',
  ...
  'Salesforce (São Paulo)': 'salesforce-s-o-paulo',
  ...
  'Google Cloud (São Paulo)': 'google-cloud-s-o-paulo',
  ...
  'Microsoft Azure (São Paulo)': 'microsoft-azure-s-o-paulo',
  ...
  'CallRail (São Paulo)': 'callrail-s-o-paulo',
  ...
  'WordPress Site (São Paulo)': 'wordpress-site-s-o-paulo'
};
